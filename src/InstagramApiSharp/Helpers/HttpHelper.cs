...
namespace InstagramApiSharp.Helpers
{
    public class HttpHelper
    {
        ...
        public HttpRequestMessage GetDefaultRequest(HttpMethod method, Uri uri, AndroidDevice deviceInfo)
        {
            ...
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_APP_LOCALE.ToLower() : InstaApiConstants.HEADER_X_IG_APP_LOCALE, InstaApiConstants.ACCEPT_LANGUAGE.Replace("-", "_"));
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_DEVICE_LOCALE.ToLower() : InstaApiConstants.HEADER_X_IG_DEVICE_LOCALE, InstaApiConstants.ACCEPT_LANGUAGE.Replace("-", "_"));
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_MAPPED_LOCALE.ToLower() : InstaApiConstants.HEADER_X_IG_MAPPED_LOCALE, InstaApiConstants.ACCEPT_LANGUAGE.Replace("-", "_"));
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_PIGEON_SESSION_ID.ToLower() : InstaApiConstants.HEADER_PIGEON_SESSION_ID, deviceInfo.PigeonSessionId.ToString());
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_PIGEON_RAWCLINETTIME.ToLower() : InstaApiConstants.HEADER_PIGEON_RAWCLINETTIME, $"{DateTime.UtcNow.ToUnixTime()}.0{Rnd.Next(10, 99)}");
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_CONNECTION_SPEED.ToLower() : InstaApiConstants.HEADER_X_IG_CONNECTION_SPEED, "-1kbps");
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_BANDWIDTH_SPEED_KBPS.ToLower() : InstaApiConstants.HEADER_X_IG_BANDWIDTH_SPEED_KBPS, deviceInfo.IGBandwidthSpeedKbps);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_BANDWIDTH_TOTALBYTES_B.ToLower() : InstaApiConstants.HEADER_X_IG_BANDWIDTH_TOTALBYTES_B, deviceInfo.IGBandwidthTotalBytesB);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_BANDWIDTH_TOTALTIME_MS.ToLower() : InstaApiConstants.HEADER_X_IG_BANDWIDTH_TOTALTIME_MS, deviceInfo.IGBandwidthTotalTimeMS);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_APP_STARTUP_COUNTRY.ToLower() : InstaApiConstants.HEADER_IG_APP_STARTUP_COUNTRY, InstaApiConstants.HEADER_IG_APP_STARTUP_COUNTRY_VALUE);
            ...
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_BLOKS_ENABLE_RENDERCODE.ToLower() : InstaApiConstants.HEADER_X_IG_BLOKS_ENABLE_RENDERCODE, "false");
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_DEVICE_ID.ToLower() : InstaApiConstants.HEADER_X_IG_DEVICE_ID, deviceInfo.DeviceGuid.ToString());
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_ANDROID_ID.ToLower() : InstaApiConstants.HEADER_X_IG_ANDROID_ID, deviceInfo.DeviceId);

            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_CONNECTION_TYPE.ToLower() : InstaApiConstants.HEADER_IG_CONNECTION_TYPE, InstaApiConstants.IG_CONNECTION_TYPE);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_CAPABILITIES.ToLower() : InstaApiConstants.HEADER_IG_CAPABILITIES, _apiVersion.Capabilities);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_APP_ID.ToLower() : InstaApiConstants.HEADER_IG_APP_ID, InstaApiConstants.IG_APP_ID);

            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_IG_TIGON_RETRY.ToLower() : InstaApiConstants.HEADER_X_IG_TIGON_RETRY, "False");
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_USER_AGENT.ToLower() : InstaApiConstants.HEADER_USER_AGENT, userAgent);
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_ACCEPT_LANGUAGE.ToLower() : InstaApiConstants.HEADER_ACCEPT_LANGUAGE, InstaApiConstants.ACCEPT_LANGUAGE);


            if (!string.IsNullOrEmpty(mid))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_MID.ToLower() : InstaApiConstants.HEADER_X_MID, mid);

            if (!string.IsNullOrEmpty(dsUserId) && !string.IsNullOrEmpty(authorization) && !string.IsNullOrEmpty(igDirectRegionHint))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_U_DIRECT_REGION_HINT.ToLower() : InstaApiConstants.HEADER_IG_U_DIRECT_REGION_HINT, igDirectRegionHint);

            if (!string.IsNullOrEmpty(dsUserId) && !string.IsNullOrEmpty(authorization) && !string.IsNullOrEmpty(shbid))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_U_SHBID.ToLower() : InstaApiConstants.HEADER_IG_U_SHBID, shbid);

            if (!string.IsNullOrEmpty(dsUserId) && !string.IsNullOrEmpty(authorization) && !string.IsNullOrEmpty(shbts))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_U_SHBTS.ToLower() : InstaApiConstants.HEADER_IG_U_SHBTS, shbts);

            if (!string.IsNullOrEmpty(dsUserId) && !string.IsNullOrEmpty(authorization))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_U_DS_USER_ID.ToLower() : InstaApiConstants.HEADER_IG_U_DS_USER_ID, dsUserId);

            if (!string.IsNullOrEmpty(dsUserId) && !string.IsNullOrEmpty(authorization) && !string.IsNullOrEmpty(rur))
                request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_IG_U_RUR.ToLower() : InstaApiConstants.HEADER_IG_U_RUR, rur);
            ...
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_FB_HTTP_ENGINE.ToLower() : InstaApiConstants.HEADER_X_FB_HTTP_ENGINE, "Liger");
            request.Headers.Add(IsNewerApis ? InstaApiConstants.HEADER_X_FB_HTTP_IP.ToLower() : InstaApiConstants.HEADER_X_FB_HTTP_IP, "True");
