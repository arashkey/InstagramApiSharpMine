...
{
    internal static class RealtimePayload
    {
        ...
        public static async Task<IByteBuffer> BuildPayload(IInstaApi instaApi)
        {
            InstaApi = instaApi;
            ...
            var compressed = Unpooled.CopiedBuffer(ZlibHelper.Compress(rawPayload));
            return compressed;
        }
